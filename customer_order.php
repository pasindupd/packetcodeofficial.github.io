	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			...
			<ul class="nav navbar-nav">
				<li><a href="order.php"><span class="glyphicon glyphicon-home"></span>Goto Order</a></li>
				<li><a href="cart.php"><span class="glyphicon glyphicon-modal-window"></span>Goto Cart</a></li>
			</ul>
		</div>
	</div>
	<p><br/></p>
