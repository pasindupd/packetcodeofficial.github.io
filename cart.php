...
<div class="wait overlay">
	...
	<!--<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				...
				<li><a href="order.php"><span class="glyphicon glyphicon-modal-window"></span> Goto Order Now</a></li>
			</ul>
		</div>
	</div>
	</div>
	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				<li><a href="index.php" accesskey="1" title="" style="background-color:  #af1641">Home Page</a></li>
				<li class="active"><a href="order.php" accesskey="4" title="">Order Now</a></li>
	...
	<div id="banner">
			...
			<div class="title">
				<h2> Your Cart </h2>
				<span class="byline">Check Your items</span> <br><br><br><br>
